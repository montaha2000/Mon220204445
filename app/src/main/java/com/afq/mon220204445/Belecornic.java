...
public class Belecornic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_belecornic);
    ...
    public void buildRecycler() {
        ...
        mAdapter = new ClassAdapter(models, Belecornic.this);
        ...
        mAdapter.OnnameClickListener(new ClassAdapter.OnnameClickListener() {
            ...
            public void onnameItemClick(int position) {
                Intent detailIntent = new Intent(Belecornic.this, Dfood.class);
    ...
    public void showdata() {
        ...
        myRef.child("electronic ").addChildEventListener(new ChildEventListener() {
            @Override
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Belecornic.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}